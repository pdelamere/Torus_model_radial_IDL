...
r = {rates, Tel: Te0, is: 0.0, isp: 0.0, is2p: 0.0, rs3p: 0.0, rs2p: 0.0,$
            ...
            cx_k15: 0.0, cx_k16: 0.0, emisSII: fltarr(31*10,41*10), emisSIII: fltarr(31*10,41*10), $
            emisSIV: fltarr(31*10,41*10), emisOII: fltarr(31*10,41*10), $
            emisOIII: fltarr(31*10,41*10), $
            emistemp: fltarr(31*10), emisden: fltarr(41*10), $
...
r1 = {rates_1, Tel: Te0, is: 0.0, isp: 0.0, is2p: 0.0, rs3p: 0.0, rs2p: 0.0,$
            ...
            cx_k5: 0.0, cx_k6: 0.0, cx_k7: 0.0, cx_k8: 0.0, cx_k9: 0.0, $
            cx_k10: 0.0, cx_k11: 0.0, cx_k12: 0.0, cx_k13: 0.0, cx_k14: 0.0,$
            cx_k15: 0.0, emisSII: fltarr(31*10,41*10), emisSIII: fltarr(31*10,41*10), $
            emisSIV: fltarr(31*10,41*10), emisOII: fltarr(31*10,41*10), $
            emisOIII: fltarr(31*10,41*10), $
            emistemp: fltarr(31*10), emisden: fltarr(41*10), $
            Puv: 0.0, psp: 0.0, ps2p: 0.0, ps3p: 0.0, $
...
read_emission_tables,'tepSII',temp,den,emisSII & r.emisSII = rebin(emisSII,31*10,41*10)
read_emission_tables,'tepSIII',temp,den,emisSIII & r.emisSIII = rebin(emisSIII,31*10,41*10)
read_emission_tables,'tepSIV',temp,den,emisSIV & r.emisSIV = rebin(emisSIV,31*10,41*10)
read_emission_tables,'tepOII',temp,den,emisOII & r.emisOII = rebin(emisOII,31*10,41*10)
read_emission_tables,'tepOIII',temp,den,emisOIII & r.emisOIII = rebin(emisOIII,31*10,41*10)
r.emistemp=rebin(temp,31*10)
r.emisden=rebin(den,41*10)
