...
L = r.isp*ftavg_el(n.nsp,n,h.sp,h,h.sp) + r.cx_k13*ftavg(n.no2p,n.nsp,h.o2p,h.sp,h.sp) + $
    ...
    r.cx_k16*ftavg(n.ns3p,n.nsp,h.s3p,h.sp,h.sp)
...
L = r.iop*ftavg_el(n.nop,n,h.op,h,h.op) + n.nop*r.Transport + $
    ...
    r.cx_k9*ftavg_n(n.nop,n.ns,h.op,h.s,h.op)
...
;endfor
nuarr = 1.8e-19*sqrt(me*mi)*(Z^2)*nel*nion*lambda/(mi*Tel + me*Ti)^(3./2.)


;print,'nu_ie(0)...',nu_ie
nu_ie = total(nuarr*nion)/total(nion)
;print,'<nu_ie>...',nu_ie
...
;print,'nu_ei(0)...',nu_ei
nu_ei = total(nuarr*nel)/total(nel)
;print,'<nu_ei>...',nu_ei
...
;endfor
nuarr = 1.8e-19*sqrt(me*me)*nel*nelec_h*lambda/(me*Tel + me*Telh)^(3./2.)
...
nu_ii = total(nu_ii*n1arr)/total(n1arr)
