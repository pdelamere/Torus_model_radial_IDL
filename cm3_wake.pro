...
a = 5.5*Rj
b = 7.0*Rj
;vol = 0.25*!pi^2*(a+b)*(b-a)^2  ;torus volume
vol = (4./3.)*!pi*(2.0*Rio)^3 ;vol of Io space
...
print,'nu_ee...',nu_ee(n.fc*n.nel,n.fh*n.nel,T.Tel_el,T.Telh)*(T.Telh - T.Tel_el)
...
print,'nu_ie (S+, cold,hot)...',nu_ie(32.0,1.0,n.fc*n.nel,n.nsp,T.Tel_sp,T.Tsp),$
...
n = {density, nel: nel0, ns: 0*ns0, nsp: nsp0, ns2p: ns2p0, ns3p: ns3p0,$
              no: 0*no0, nop: nop0, no2p: no2p0, fc: fc, fh: fh, $
...
plot_io,[0,ntm*dt]/8.64e4,[0.1,2000.0],/nodata,$
  title='Temperature',$
  xtitle='time (days) ',ytitle='T (eV)',yrange=[0.1,2000.0],/ysty,$
  xrange=[0,dt*ntm]/8.64e4,/xsty
endif
