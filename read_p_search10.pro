...
s = {params,fh: 0.0, fha: 0.0, ns: 0.0, nsa:0.0, dll:0.0, dlla: 0.0, teh: 0.0, teha: 0.0, $
            mr: fltarr(12), nelec: 0.0, tionavg: 0.0,peuv:0.0, chi: 0.0}
...
plot,nrun,p.tionavg,title='<Ti>'
plots,[!x.crange(0),!x.crange(1)],[70.0,70.0],linestyle=1
plot,nrun,p.chi,title='CHI^2


;endwhile

wh = where(p.chi le 5.0)
