...
;print,'S+ source...',Lshl,r.S_production,net_source
...
;print,Lshl,r.S_production,net_source,vol
;print,Lshl,r.O_production
...
;if (Lshl le 6.1) then begin
;print,' '
;print,'S source......................',r.S_production ;+ r.cx_k8*ftavg(n.no,n.nsp)/S
;print,'n.s............................',n.ns
;print,'S loss thermal elec impact....',r.is*ftavg_n_el(n.ns,n,h.s,h,h.s)/L
;print,'S loss hot elec impact........',r.ish*ftavg_n_elh(n.ns,n,h.s,h,h.s)/L
;print,'S loss k4.....................',r.cx_k4*ftavg_n(n.ns3p,n.ns,h.s3p,h.s,h.s)/L
;print,'S loss k11....................',r.cx_k11*ftavg_n(n.no2p,n.ns,h.o2p,h.s,h.s)/L
;print,'S loss k10....................',r.cx_k10*ftavg_n(n.no2p,n.ns,h.o2p,h.s,h.s)/L
;print,'S loss k2.....................',r.cx_k2*ftavg_n(n.ns2p,n.ns,h.s2p,h.s,h.s)/L
;print,'S loss k9.....................',r.cx_k9*ftavg_n(n.nop,n.ns,h.op,h.s,h.s)/L
;print,'S loss k3.....................',r.cx_k3*ftavg_n(n.ns2p,n.ns,h.s2p,h.s,h.s)/L
;print,'S loss k1.....................',r.cx_k1*ftavg_n(n.nsp,n.ns,h.sp,h.s,h.s)/L 
;print,' '
;endif
...
;if (Lshl le 6.1) then begin
;print,'hot electron rate.....',r.ish
;print,'hot electron ns.......',n.ns
;print,'hot electron nsp.......',n.nsp
;print,'hot electron n.fh.....',n.fh
;print,'hot electron n.nel....',n.nel
;print,'hot electron h.s......',h.s/7.14e4

;print,' '
;print,'S+ source thermal electron impact...',r.is*ftavg_n_el(n.ns,n,h.s,h,h.sp)/S
;print,'S+ source hot elec impact...........',r.ish*ftavg_n_elh(n.ns,n,h.s,h,h.sp)/S
;print,'S+ source S++ recomb................',r.rs2p*ftavg_el(n.ns2p,n,h.s2p,h,h.sp)/S
;print,'S+ source k2........................',2.0*r.cx_k2*ftavg_n(n.ns2p,n.ns,h.s2p,h.s,h.sp)/S
;print,'S+ source k4........................',r.cx_k4*ftavg_n(n.ns3p,n.ns,h.s3p,h.s,h.sp)/S
;print,'S+ source k9........................',r.cx_k9*ftavg_n(n.nop,n.ns,h.op,h.s,h.sp)/S
;print,'S+ source k10.......................',r.cx_k10*ftavg_n(n.no2p,n.ns,h.o2p,h.s,h.sp)/S
;print,'S+ source k12.......................',r.cx_k12*ftavg_n(n.ns2p,n.no,h.s2p,h.o,h.sp)/S
;print,' '
;print,'S+ loss thermal electron impact.....',r.isp*ftavg_el(n.nsp,n,h.sp,h,h.sp)/L
;;print,'S+ loss Transport...................',n.nsp*r.Transport/L
;print,'S+ loss hot electron impact.........',r.isph*ftavg_elh(n.nsp,n,h.sp,h,h.sp)/L
;print,'S+ loss recomb......................',r.rsp*ftavg_el(n.nsp,n,h.sp,h,h.sp)/L
;print,'S+ loss k8..........................',r.cx_k8*ftavg_n(n.nsp,n.no,h.sp,h.o,h.sp)/L
;print,'S+ loss 13..........................',r.cx_k13*ftavg(n.no2p,n.nsp,h.o2p,h.sp,h.sp)/L
;print,'S+ loss k16.........................',r.cx_k16*ftavg(n.ns3p,n.nsp,h.s3p,h.sp,h.sp)/L
...
for i = 0,ntm do begin
   ...
   n1.ns = n.ns + dt*F_s(n,h,r,S,L,Lshl)

;   src(i).s = S
;   lss(i).s = L
   n1.nsp = n.nsp + dt*F_sp(n,h,r,S,L,Lshl)
...
;   neutral_navg,n1,n1ar,max_theta
   ...
   np.ns = n.ns + dt*0.5*(F_s(n,h,r,S,L,Lshl)+F_s(n1,h1,r,S,L,Lshl))
   np.nsp = n.nsp + dt*0.5*(F_sp(n,h,r,S,L,Lshl)+F_sp(n1,h1,r,S,L,Lshl))
